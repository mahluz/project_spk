	                ...
	                <div class="carousel-inner">
	                        ...
	                        <div class="fill" style=" background-color:#48c3af;">
	                            <div class="inner-content">
	                                <div class="carousel-img">
	                                    <img src="{{url('public/images/logo_1.png')}}" alt="sofa" class="img img-responsive" />
	                                </div>
	                    ...
	                    <div class="item item2">
	                        <div class="fill" style="background-color:#b33f4a;">
	                            <div class="inner-content">
	                                <div class="carousel-img">
	                                    <img src="{{url('public/images/gambar_2.png')}}" alt="white-sofa" class="img img-responsive" />
	                                </div>
	                                <div class="carousel-desc">
	                        ...
	                        <div class="fill" style="background-color:#7fc2f4;">
	                            <div class="inner-content">
	                                <div class="col-md-6">
	                                    ...
	                                    <div class="carousel-img">
	                                        <img src="{{url('public/images/gambar_1.png')}}" alt="sofa" class="img img-responsive" />
	                                    </div>
	                                </div>
